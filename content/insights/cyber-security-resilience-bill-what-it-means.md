---
title: "The Cyber Security and Resilience Bill: What It Means for Your Business"
...
faq:
  - question: "What is the Cyber Security and Resilience Bill?"
    answer: "It's UK legislation that reforms and expands the Network and Information Systems (NIS) Regulations 2018. It widens the range of organisations covered, tightens incident reporting timescales, and increases enforcement powers and penalties for regulators."
  - question: "When will the Cyber Security and Resilience Bill become law?"
    answer: "The Bill is progressing through Parliament, with Royal Assent expected later in 2026. Most operational requirements will follow through secondary legislation, so full implementation is likely to be phased in gradually, potentially through to 2028."
  - question: "Does the Cyber Security and Resilience Bill apply to managed service providers?"
    answer: "Yes. The Bill introduces a new category of regulated entity, the Relevant Managed Service Provider, bringing MSPs into scope for the first time alongside data centres, large-scale electricity load controllers, and organisations designated as critical suppliers."
  - question: "How does ISO 27001 help with compliance?"
    answer: "ISO 27001 certification requires a documented risk management system, an incident response process, and evidence of ongoing monitoring and review. These are the same building blocks the Bill expects organisations to have in place, so a certified ISMS gives you a head start rather than a standing start."
---
