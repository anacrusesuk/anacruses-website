      ...
      <section className="bg-navy text-white py-10 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4">
          ...
          <p className="text-xl text-blue-100 max-w-2xl">
            ...
            written by a CQI/IRCA certified Lead Auditor with 20+ years of ISO 27001 experience.
          </p>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  body: 'Confirm your ISMS scope is documented correctly and matches operational reality — including remote workers, cloud systems, and outsourced functions.',
                },
                {
                  title: 'Risk assessment and Statement of Applicability',
                  body: 'The two areas most commonly responsible for Stage 2 failures. Every required element is listed so nothing is missed.',
                },
                {
                  title: 'All 93 Annex A controls',
                  body: 'Organisational, People, Physical, and Technological controls — including the 11 new controls added in ISO 27001:2022.',
                },
                {
                  title: 'Internal audit requirements',
                  body: 'What a rigorous internal audit looks like and what certification auditors check in your audit records.',
                },
                {
                  title: 'The five most common Stage 2 failure reasons',
                  body: 'From 20+ years of conducting and supporting ISO 27001 audits — the specific gaps that cause businesses to fail or receive major nonconformities.',
                },
              ].map(item => (
            ...
            <div className="card border-t-4 border-t-gold">
              ...
              <form id="checklist-form" noValidate>
                <div className="space-y-4">
                  ...
                  <p id="form-error" className="text-red-500 text-xs hidden">
            ...
            <div className="card border-t-4 border-t-navy mt-5">
              <div className="flex items-center gap-3 mb-3">
                <img
                  src="/images/rob.jpg"
                  alt="Rob Pragnell"
                  className="w-12 h-12 rounded-full object-cover object-center border-2 border-gold"
                />
                <div>
              ...
              <p className="text-gray-600 text-xs leading-relaxed">
                CQI &amp; TRECCERT certified Lead Auditor across ISO 9001, 14001, 27001, 45001 &amp; 42001.
                Every Anacruses client works directly with Rob — not a junior consultant.
              </p>
              <Link href="/about" className="text-gold text-xs hover:underline mt-2 inline-block">
                Full biography →
              </Link>
            </div>
          </div>
