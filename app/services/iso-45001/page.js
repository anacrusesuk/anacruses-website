    ...
    <>
      <section className="bg-navy-DEFAULT text-white py-16">
        <div className="max-w-6xl mx-auto px-4">
          <span className="bg-gold-DEFAULT text-white text-xs font-bold px-2 py-1 rounded mb-4 inline-block">ISO 45001:2018</span>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-10">
          <div className="md:col-span-2 space-y-5 text-gray-700 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-navy-DEFAULT">What is ISO 45001?</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-navy-DEFAULT mt-6">Who needs ISO 45001?</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-DEFAULT mt-6">What ISO 45001 requires</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-navy-DEFAULT mt-6">Integrating ISO 45001 with your other standards</h2>
            <p>
          ...
          <aside className="space-y-5">
            <div className="card border-t-4 border-t-gold-DEFAULT">
              <h3 className="font-bold text-navy-DEFAULT mb-2 text-sm">Rob's ISO 45001 credentials</h3>
            ...
            <div className="card bg-mist">
              <h3 className="font-bold text-navy-DEFAULT mb-2 text-sm">Still on OHSAS 18001?</h3>
