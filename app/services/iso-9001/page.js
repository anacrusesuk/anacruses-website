    ...
    <>
      <section className="bg-navy-DEFAULT text-white py-16">
        <div className="max-w-6xl mx-auto px-4">
          <span className="bg-gold-DEFAULT text-white text-xs font-bold px-2 py-1 rounded mb-4 inline-block">ISO 9001:2015</span>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-10">
          <div className="md:col-span-2 space-y-5 text-gray-700 leading-relaxed">
            <h2 className="text-2xl font-bold text-navy-DEFAULT">What is ISO 9001?</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-navy-DEFAULT mt-6">Who needs ISO 9001?</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 my-6 text-center text-xs">
              {['Gap Analysis', 'Documentation', 'Training', 'Internal Audit', 'Certification'].map((step, i) => (
                <div key={step} className="bg-mist rounded p-3">
                  ...
                  <div className="font-semibold text-navy-DEFAULT">{step}</div>
                </div>
              ))}
            </div>
          ...
          <aside className="space-y-5">
            <div className="card border-t-4 border-t-gold-DEFAULT">
              <h3 className="font-bold text-navy-DEFAULT mb-2 text-sm">Rob's ISO 9001 credentials</h3>
              <ul className="text-xs text-gray-600 space-y-1.5">
                <li className="flex gap-2"><span className="text-gold-DEFAULT">◆</span>CQI/IRCA Certified Lead Auditor — ISO 9001</li>
                <li className="flex gap-2"><span className="text-gold-DEFAULT">◆</span>Over 20 years implementing ISO 9001 across multiple sectors</li>
                <li className="flex gap-2"><span className="text-gold-DEFAULT">◆</span>Internal Audit Manager experience</li>
                <li className="flex gap-2"><span className="text-gold-DEFAULT">◆</span>Approved by multiple UKAS-accredited certification bodies</li>
              </ul>
            </div>
            <div className="card">
