          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="card">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-4">
                These articles will help you understand what the checklist items mean in practice.
              </p>
