...
export const metadata = {
  ...
  description: 'Rob Pragnell is a certified Lead Auditor across ISO 9001, 14001, 27001, 45001 and 42001, and founder of Anacruses Associates Ltd, with over 20 years of ISO consultancy experience across the UK.',
};

const qualifications = [
  'CQI Certified Lead Auditor — ISO 9001, 14001 & 45001',
  'TRECCERT Certified Lead Auditor — ISO 27001 & 42001',
      ...
      <section className="py-10">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-10">
          <div className="md:col-span-2 space-y-5 text-gray-700 leading-relaxed">
            ...
            <p>
              As a certified Lead Auditor across ISO 9001, 14001, 27001, 45001 and 42001 (CQI/IRCA and TRECCERT) — and implementer for those standards — I have been on both sides of the audit table, which matters. I know what auditors look for, how findings tend to arise, and how to build a system that holds up when the pressure is on.
            </p>
            <p>
