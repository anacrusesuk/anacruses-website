  ...
  try {
    await fetch('https://api.brevo.com/v3/smtp/email', {
      ...
      body: JSON.stringify({
        ...
        subject: `New ISO 27001 lead: ${safeName || safeEmail}`,
        htmlContent: `
<html><body style="font-family:Arial,sans-serif;padding:24px;color:#2D3748;">
  ...
  <table style="border-collapse:collapse;width:100%;max-width:480px;">
    <tr>
      ...
      <td style="padding:8px 12px;border-bottom:1px solid #e2e8f0;">${safeName || '(not provided)'}</td>
    </tr>
    <tr>
      <td style="padding:8px 12px;background:#EAF2F8;font-weight:bold;color:#1B2A4A;">Email</td>
      <td style="padding:8px 12px;border-bottom:1px solid #e2e8f0;"><a href="mailto:${safeEmail}" style="color:#C9A84C;">${safeEmail}</a></td>
    </tr>
    <tr>
  ...
  <p style="margin-top:24px;">
    <a href="mailto:${safeEmail}?subject=Your ISO 27001 Certification Checklist"
