exports.handler = async function (event) {
  ...
  // 1. Add contact to Brevo List 7 (ISO 9001 Leads)
  try {
  ...
  try {
    const emailRes = await fetch('https://api.brevo.com/v3/smtp/email', {
      ...
      body: JSON.stringify({
        ...
        subject: 'Your ISO 9001 Certification Checklist',
...
<a href="https://www.anacruses.co.uk/ISO-9001-Certification-Checklist-UK.pdf"
...
<p style="margin:0 0 16px;color:#2D3748;font-size:15px;line-height:1.6;">The checklist covers all seven areas your certification body will examine — from context and leadership through to internal audit and continual improvement. Every item marked <strong>Required</strong> must be evidenced before your Stage 2 audit.</p>
...
<p style="margin:0;color:#8899aa;font-size:11px;line-height:1.5;">You received this email because you requested the ISO 9001 Certification Checklist from anacruses.co.uk. Your data is held securely and will never be shared with third parties.
